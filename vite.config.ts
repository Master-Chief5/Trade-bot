...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Ryan Hall Room Check',
        short_name: 'Room Check',
        description: 'Nightly room check for Ryan Hall. RAs record who is present; deans print the sheet.',
        theme_color: '#24466E',
  ...
  build: {
    ...
    rollupOptions: { output: { manualChunks: { pdf: ['jspdf', 'jspdf-autotable'], react: ['react', 'react-dom', 'react-router-dom'] } } },
  },
  test: {
    environment: 'jsdom',
    globals: true,
